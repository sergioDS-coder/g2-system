...
async function loadImageFile(src) {
...
function canvasHalfToPng(canvas, sy) {
...
export async function renderArtifactImage(artifactId) {
...
export async function renderClassImage(classId) {
    const canvas = document.createElement('canvas');
    canvas.width = ART_IMG_W;
    canvas.height = ART_IMG_H;
    const ctx = canvas.getContext('2d');
